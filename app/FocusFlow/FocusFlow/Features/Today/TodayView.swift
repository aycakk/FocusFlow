        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // Quiet AI note at the bottom — generated by the backend
                    if !focusTasks.isEmpty && !insight.isEmpty {
                        insightNote
                    }
                ...
                .task {
                    insight = await ai.insightNote(
                        completedToday: doneTasks.count,
                        totalToday: focusTasks.count
                    )
                }
